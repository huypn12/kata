...
int GetMaxSubArray(int *A, int N, int K, int L)
{
    ...
    for (int i = 0; i <= N - K; i++) {
        ...
        for (int j = 0; j <= N - L; j++) {
            ...
            if (!(                                                            /* not overlap */
                  ((alice_lower < bob_lower) && (alice_upper < bob_upper)) || /* alice before */
                  ((alice_lower > bob_lower) && (alice_upper > bob_upper)) || /* alice after */
                  ((alice_lower > bob_lower) && (alice_upper < bob_upper))
                  ||                                                       /* bob contains alice */
                  ((alice_lower < bob_lower) && (alice_upper > bob_upper)) /* alice contains bob */
                  )) {
